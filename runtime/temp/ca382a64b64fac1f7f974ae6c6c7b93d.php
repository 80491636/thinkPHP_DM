<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\phpStudy\PHPTutorial\WWW\dm\public/../application/admin\view\bander\edit.html";i:1564663259;s:69:"D:\phpStudy\PHPTutorial\WWW\dm\application\admin\view\common\top.html";i:1564048490;s:70:"D:\phpStudy\PHPTutorial\WWW\dm\application\admin\view\common\left.html";i:1564662853;}*/ ?>
<!DOCTYPE html>
<html>
                                        ...
                                        <div id="horizontal-form">
                                            <form class="form-horizontal" role="form" action="" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" value="<?php echo $link['title']; ?>" id="title" placeholder=""
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" value="<?php echo $link['url']; ?>" id="url" placeholder="" name="url"
                                                        required="" type="text">
                                                    </div>
                                                    <p class="help-block col-sm-4 red">
                                                        * 必填
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <textarea class="form-control" name="content" id="content"><?php echo $link['content']; ?></textarea>
                                                    </div>
