<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\phpStudy\PHPTutorial\WWW\dm\public/../application/admin\view\tags\lst.html";i:1564657389;s:69:"D:\phpStudy\PHPTutorial\WWW\dm\application\admin\view\common\top.html";i:1564048490;s:70:"D:\phpStudy\PHPTutorial\WWW\dm\application\admin\view\common\left.html";i:1564656574;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="page-content">
                    ...
                    <div class="page-breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">tags列表</li></ul>
                    </div>
                    <!-- /Page Breadcrumb -->
                    <!-- Page Body -->
                    <div class="page-body">
                        <button type="button" tooltip="添加tags" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('tags/add'); ?>'">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center"><?php echo $user['types']; ?></td>
