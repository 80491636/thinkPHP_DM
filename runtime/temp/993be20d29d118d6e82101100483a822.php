<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\phpStudy\PHPTutorial\WWW\dm\public/../application/admin\view\tags\edit.html";i:1564657993;s:69:"D:\phpStudy\PHPTutorial\WWW\dm\application\admin\view\common\top.html";i:1564048490;s:70:"D:\phpStudy\PHPTutorial\WWW\dm\application\admin\view\common\left.html";i:1564656574;}*/ ?>
<!DOCTYPE html>
<html>
                                        ...
                                        <div id="horizontal-form">
                                            <form class="form-horizontal" role="form" enctype="multipart/form-data" action="" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="tagname" placeholder="" name="tagname" value="<?php echo $tag['tagname']; ?>"
                                                        required="" type="text">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select name="types">
                                                            ...
                                                            <option value ="类型" <?php if($tag['types'] == '类型'): ?> selected <?php endif; ?> >类型</option>
                                                            <option value ="年代" <?php if($tag['types'] == '年代'): ?> selected <?php endif; ?> >年代</option>
