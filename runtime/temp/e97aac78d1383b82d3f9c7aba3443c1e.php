                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <a href="<?php echo url('cate/edit',array('id'=>$user['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                                <i class="fa fa-edit"></i>编辑</a>
                                                            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('cate/del',array('id'=>$user['id'])); ?>')" class="btn btn-danger btn-sm shiny">
