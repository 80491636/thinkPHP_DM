<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\Program Files\Apache24\htdocs\dm\public/../application/index\view\playlst\playlst.html";i:1564151761;s:74:"D:\Program Files\Apache24\htdocs\dm\application\index\view\common\top.html";i:1564153107;s:75:"D:\Program Files\Apache24\htdocs\dm\application\index\view\common\foot.html";i:1564148032;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="wrap eb-head-width g-clear">
            <ul id="js-ebhead-more" class="eb-head-nav g-clear">
                <li class="eb-head-nav-wrap js-ebsubhead-menu">
                    <a href="https://www.360kan.com" class="nav-item current" target="_self">首页</a></li>
                <?php if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <li class="eb-head-nav-wrap js-ebsubhead-menu">
                    <a href="<?php echo url('videolst/index',array('id'=>$vo['id'])); ?>" class="nav-item" target="_self"><?php echo $vo['catename']; ?></a>
                </li>
                    ...
                    <div class="m-top-left">
                        <div class="s-cover" data-block="tj-cover" monitor-desc="大海报" monitor-shortpv="" id="js-s-cover">
                            <a href="http://v.qq.com/x/page/m00253deqqo.html?ptag=360kan.cartoon.free" class="g-playicon s-cover-img" data-daochu="to=qq" data-num="1">
                                <img src="./playList_files/dy_695e41b4208ee7f19ee1c741bb703d3d_">
                                <i class="ico-pay"></i>
                            </a>
                        </div>
                    </div>
                        ...
                        <div data-block="tj-info" monitor-desc="详细信息" monitor-shortpv="" class="m-top-info">
                            ...
                            <div id="js-desc-switch" class="m-top-info-detail g-clear">
                                <div class="g-clear item-wrap">
                                    <p class="item">
                                        <span>类型 ：</span>
                                        <a class="cat first" href="http://www.360kan.com/dongman/list.php?year=all&amp;area=all&amp;act=all&amp;cat=100" target="_blank">热血</a>
                                        <a class="cat" href="http://www.360kan.com/dongman/list.php?year=all&amp;area=all&amp;act=all&amp;cat=109" target="_blank">魔幻</a>
                                        <span class="cat">战斗</span></p>
                                    <p class="item">
                                        <span>年代 ：</span>2018</p>
                                    <p class="item">
                                        <span>地区 ：</span>
                                        <a class="area first" href="http://www.360kan.com/dongman/list.php?cat=all&amp;year=all&amp;act=all&amp;area=10" target="_blank">大陆</a></p>
                                    <p style="clear:both"></p>
                                    <p class="item item-director">
                                        <span>导演 ：</span>
                                        <a class="name" href="http://so.360kan.com/index.php?kw=%E6%B2%88%E4%B9%90%E5%B9%B3&amp;from=yingshi">沈乐平</a>&nbsp;</p>
                                    <p class="item item-actor">
                                        <span>人物 ：</span>
                                        <a class="name" href="http://so.360kan.com/index.php?kw=%E6%B2%88%E7%A3%8A&amp;from=yingshi">沈磊</a>&nbsp;/
                                        <a class="name" href="http://so.360kan.com/index.php?kw=%E7%A8%8B%E7%8E%89%E7%8F%A0&amp;from=yingshi">程玉珠</a>&nbsp;/
                                        <a class="name" href="http://so.360kan.com/index.php?kw=%E9%BB%84%E7%BF%94%E5%AE%87&amp;from=yingshi">黄翔宇</a>&nbsp;</p></div>
                                <div class="item-desc-wrap g-clear js-open-wrap">
                                    <span>简介 ：</span>
                                    <p class="item-desc">唐门外门弟子唐三，因偷学内门绝学为唐门所不容，跳崖明志时却发现没有死，反而以另外一个身份来到了另一个世界，一个属于武...
                        ...
                        <div>
                            <div id="js-siteact" class="m-top-list" data-block="tj-site" monitor-desc="剧集" monitor-shortpv="">
                                <div class="m-top-list-zd g-clear m-top-list-zd-wide">
                                    <div style=" visibility:hidden" class="js-s-hitclient s-hitclient s-hitclient-dongman">
                                        <label>
                                            <input checked="" type="checkbox">安装影视大全，剧集更新时自动提醒</label></div>
                                    <div class="s-playsite" id="js-s-playsite">
                                        <p class="js-current s-playsite-current">
                                            <span class="ea-site ea-site-qq">腾讯</span></p>
                                        <div class="sites js-sites">
                                            <div class="sites-inner">
                                                <p class="arrow"></p>
                                                <ul class="js-list">
                                                    <li>
                                                        <span class="ea-site ea-site-qq">腾讯</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="site-wrap" id="js-site-wrap">
                                    ...
                                    <div class="m-series-content js-tab-content" data-default="t_4_OUPkaZ7kNY7vDj_qq">
                                        <div class="js-series-part m-series-number-container g-clear" data-daochu="to=qq&amp;id=OUPkaZ7kNY7vDj&amp;category=4">
                                            ...
                                            <a href="https://www.360kan.com/ct/OUPkaZ7kNY7vDj.html###" title="展开" class="expand-series js-expand-series" target="_self">...</a>
