<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\phpStudy\PHPTutorial\WWW\dm\public/../application/admin\view\bander\lst.html";i:1564663012;s:69:"D:\phpStudy\PHPTutorial\WWW\dm\application\admin\view\common\top.html";i:1564048490;s:70:"D:\phpStudy\PHPTutorial\WWW\dm\application\admin\view\common\left.html";i:1564662853;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="page-content">
                    ...
                    <div class="page-breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">轮播图列表</li></ul>
                    </div>
                    <!-- /Page Breadcrumb -->
                    <!-- Page Body -->
                    <div class="page-body">
                        <button type="button" tooltip="添加轮播图" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('bander/add'); ?>'">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center"><?php echo $user['url']; ?></td>
                                                        <td align="center"><?php echo $user['content']; ?></td>
                                                        <td align="center">
                                                            <a href="<?php echo url('bander/edit',array('id'=>$user['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                                <i class="fa fa-edit"></i>编辑</a>
                                                            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('bander/del',array('id'=>$user['id'])); ?>')" class="btn btn-danger btn-sm shiny">
